...
class Movie(models.Model):
    ...
    backdrop_path = models.CharField(max_length=512, blank=True, null=True)
    release_date = models.DateField(blank=True, null=True)
    vote_average = models.FloatField(blank=True, null=True)
    vote_count = models.IntegerField(blank=True, null=True)
    count_like = models.IntegerField(default=0)
    popularity = models.FloatField(blank=True, null=True)
    original_language = models.CharField(max_length=128, blank=True, null=True)
    adult = models.BooleanField(default=False)
    video = models.BooleanField(default=False)
    runtime=models.CharField(max_length=4, blank=True, null=True)
    genres = models.ManyToManyField("Genre")
    origin_country = models.CharField(max_length=128, blank=True, null=True)
